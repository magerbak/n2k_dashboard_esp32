...
const uint8_t FreeSansObliqueMod9pt7bBitmaps[] PROGMEM = {
    ...
    0xC2, 0x10, 0x88, 0xC6, 0x18, 0x88, 0x42, 0x10, 0x88, 0xC0, 0x7B, 0x38,
    0x61, 0xCD, 0xE0 };

const GFXglyph FreeSansObliqueMod9pt7bGlyphs[] PROGMEM = {
    {0, 1, 1, 5, 0, 0},         // 0x20 ' '
    {1, 5, 13, 5, 2, -12},      // 0x21 '!'
    {10, 5, 4, 6, 3, -12},      // 0x22 '"'
    ...
    {1366, 6, 6, 11, 5, -12},   // 0x7E '~' replaced by '°'
};

const GFXfont FreeSansObliqueMod9pt7b PROGMEM = {
  (uint8_t  *)FreeSansObliqueMod9pt7bBitmaps,
  (GFXglyph *)FreeSansObliqueMod9pt7bGlyphs,
  0x20, 0x7E, 21 };
