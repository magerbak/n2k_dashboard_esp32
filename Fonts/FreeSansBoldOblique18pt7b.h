...
const uint8_t FreeSansBoldObliqueMod18pt7bBitmaps[] PROGMEM = {
    ...
    0x00, 0xF8, 0x00, 0x1F, 0x07, 0xF1, 0xC7, 0x70, 0x7C, 0x07, 0x80, 0xF0,
    0x1F, 0x07, 0x71, 0xC7, 0xF0, 0x7C, 0x00 };

const GFXglyph FreeSansBoldObliqueMod18pt7bGlyphs[] PROGMEM = {
    {0, 1, 1, 10, 0, 0},        // 0x20 ' '
    ...
    {5259, 11, 11, 21, 8, -23}, // 0x7E '~' replaced by '°'
};

const GFXfont FreeSansBoldObliqueMod18pt7b PROGMEM = {
  (uint8_t  *)FreeSansBoldObliqueMod18pt7bBitmaps,
  (GFXglyph *)FreeSansBoldObliqueMod18pt7bGlyphs,
  0x20, 0x7E, 42 };
