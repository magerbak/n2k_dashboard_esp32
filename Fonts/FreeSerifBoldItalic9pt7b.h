...
const uint8_t FreeSerifBoldItalicMod9pt7bBitmaps[] PROGMEM = {
    ...
    0xE0, 0x74, 0x63, 0x17, 0x00 };

const GFXglyph FreeSerifBoldItalicMod9pt7bGlyphs[] PROGMEM = {
    {0, 1, 1, 5, 0, 0},         // 0x20 ' '
    {1, 6, 13, 7, 1, -11},      // 0x21 '!'
    {11, 6, 5, 10, 3, -11},     // 0x22 '"'
    ...
    {1309, 5, 5, 7, 3, -11},    // 0x7E '~' replaced by '°'
};

const GFXfont FreeSerifBoldItalicMod9pt7b PROGMEM = {
  (uint8_t  *)FreeSerifBoldItalicMod9pt7bBitmaps,
  (GFXglyph *)FreeSerifBoldItalicMod9pt7bGlyphs,
  0x20, 0x7E, 21 };
