...
const uint8_t FreeMonoBoldObliqueMod12pt7bBitmaps[] PROGMEM = {
    ...
    0xC0, 0xC0, 0xE0, 0x70, 0x30, 0x38, 0x78, 0x38, 0x00, 0x1E, 0x23, 0x41,
    0x81, 0x81, 0x82, 0xC4, 0x78 };

const GFXglyph FreeMonoBoldObliqueMod12pt7bGlyphs[] PROGMEM = {
    {0, 1, 1, 14, 0, 0},        // 0x20 ' '
    {1, 6, 15, 14, 6, -14},     // 0x21 '!'
    {13, 8, 7, 14, 6, -13},     // 0x22 '"'
    ...
    {1965, 8, 8, 14, 5, -13},   // 0x7E '~' replaced by '°'
};

const GFXfont FreeMonoBoldObliqueMod12pt7b PROGMEM = {
  (uint8_t  *)FreeMonoBoldObliqueMod12pt7bBitmaps,
  (GFXglyph *)FreeMonoBoldObliqueMod12pt7bGlyphs,
  0x20, 0x7E, 24 };
