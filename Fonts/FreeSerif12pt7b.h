...
const uint8_t FreeSerifMod12pt7bBitmaps[] PROGMEM = {
...
const GFXglyph FreeSerifMod12pt7bGlyphs[] PROGMEM = {
    {0, 1, 1, 6, 0, 0},         // 0x20 ' '
    {1, 2, 16, 8, 3, -15},      // 0x21 '!'
    {5, 6, 6, 10, 1, -15},      // 0x22 '"'
    ...
    {1835, 7, 7, 10, 1, -15},   // 0x7E '~' replaced by '°'
};

const GFXfont FreeSerifMod12pt7b PROGMEM = {
  (uint8_t  *)FreeSerifMod12pt7bBitmaps,
  (GFXglyph *)FreeSerifMod12pt7bGlyphs,
  0x20, 0x7E, 28 };
